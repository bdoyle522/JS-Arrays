...
//Create a function named 'looper' that is given family as it's only argument, loops through the given array, and 
//alerts every item in the array.
function looper(fam){
...
//Have divider return an Array with the first item in the array being the evens array (all the even values from 
//nums) and the second item in the Array being the odds array(all the odd values from nums).
...
//Write a function called reverse that takes a given str as it's only argument and returns that string after it's 
//been reversed
